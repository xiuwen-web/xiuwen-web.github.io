...
export default function Home() {
  return (
    /*
     * No wrapper. The variant needed one to scope its fonts to a single
     * route; the fonts are loaded at the root now, and the grain layer
     * moved to layout.tsx so the case studies are made of the same
     * material as the page that links to them.
     */
